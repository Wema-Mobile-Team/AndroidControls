    ...
    public class BeneficairyAdapter : RecyclerView.Adapter
    {
       public  List<BeneficairyModel> beneficairies;
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            vh.txtSubstring.Text = CollectFirstLetter(beneficairies[position].benName); 
        ...
        internal void UpdateData(List<BeneficairyModel> post)
        {
            this.beneficairies = post;
            NotifyDataSetChanged();
        }


        public string CollectFirstLetter(string value)
        {
            return !string.IsNullOrEmpty(value) ? value.Substring(0,1) : "";
        }

        public class BeneficairyViewHolder : RecyclerView.ViewHolder
        {
            public TextView txtSubstring { get; set; }
            ...
            {
               txtSubstring = view.FindViewById<TextView>(Resource.Id.txt_subString);
